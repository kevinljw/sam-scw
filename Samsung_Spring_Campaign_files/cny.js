...
href;
    ...
    var pageT = [],
        ...
        pageName = ['kv', 'main', 'z-series', 's21', 'n20', 'tab-s7','tab-a7', 'video', 'moresp', 'buy'];
    ...
    function navde() {
        ...
        TweenMax.to('.myheader', .1, {ease: Quart.easeOut });
    ...
    function navfunc() {
        ...
        if (navopen == 0) {
            ...
            TweenMax.to('.myheader', .5, {delay: 0, ease: Quart.easeOut });
            $('.mainnav').slideUp();
...
$(function () {
    ...
    //     }
    // };
    // $('#demo li').click(stopVideo);
    // $('#demo .arrow-left').click(stopVideo);
    // $('#demo .arrow-right').click(stopVideo);
});

$(document).ready(function () {
    var taggingFunc = function() {
        _lt('send', 'cv', {type: '2021Spring_BTN'},['d32026ff-0c57-4140-9db5-5bba1f58fc94']);
        
        fbq('track', 'IM_CUSTOM',{product_id:'2021SPRINGCAMPAIGN',});
        
        gtag('event', 'conversion', {'allow_custom_scripts': true,'send_to': 'DC-9052290/2021000/td20200+standard'});
        ...
        window.dotq.push(
        {
          ...
          'properties': {
            ...
            'qstrings': {
              'et': 'custom',
              'ea': '406503button1_20210331'
            }
        } } );
    };
    var taggingFuncLogin = function() {
        _lt('send', 'cv', {type: '2021Spring_BTN'},['d32026ff-0c57-4140-9db5-5bba1f58fc94']);
        ...
        window.dotq.push(
        {
          ...
          'properties': {
            ...
            'qstrings': {
              'et': 'custom',
              'ea': '406503button2_20210331'
            }
        } } );
    };
    
    $( '#buy_now_zflod2' ).click(taggingFunc);
    $( '#buy_now_s21' ).click(taggingFunc);
    $( '#buy_now_note20' ).click(taggingFunc);
    $( '#buy_now_tab_s7' ).click(taggingFunc);
    $( '#buy_now_buds_pro' ).click(taggingFunc);
    $( '#buy_now_watch' ).click(taggingFunc);
    //sec3
    $( '#z_series-buy_now_zflod2' ).click(taggingFunc);
    $( '#z_series-log_in' ).click(taggingFuncLogin);
//    $( '#z_series-buy_ses' ).click(taggingFunc);
    //sec4
    $( '#s21-buy_now' ).click(taggingFunc);
    $( '#s21-log_in' ).click(taggingFuncLogin);
//    $( '#s21-buy_ses' ).click(taggingFunc);
    //sec 5
    $( '#n20-buy_now' ).click(taggingFunc);
    $( '#n20-log_in' ).click(taggingFuncLogin);
//    $( '#n20-buy_ses' ).click(taggingFunc);
    //sec 6
    $( '#tab-s7-buy_now').click(taggingFunc);
    $( '#tab-s7-log_in').click(taggingFuncLogin);
//    $( '#tab-s7-buy_ses').click(taggingFunc);
    
    $( '#tab-a7-buy_now').click(taggingFunc);
    // sec 8
//    $( '#moresp-learn_more_togo' ).click(taggingFunc);
//    $( '#moresp-learn_more_roadshow' ).click(taggingFunc);
//    $( '#moresp-learn_more_workshop' ).click(taggingFunc);
    //sec 9
    $( '#buy-buy_now_left' ).click(taggingFunc);
    $( '#buy-buy_now_right' ).click(taggingFunc);
//    $( '#buy-learn_more' ).click(taggingFunc);
    
    $("#youtube-arrow-right,#youtube-arrow-left").click(function(){
        $('#demo.carousel iframe').each(function(){
